...
export function FundingPage() {
  ...
  return <>
    <PageHeading eyebrow="A LITTLE TO GET STARTED" title="Make your first deposit." description="Explore how you could add funds. Every option below is simulated, and no money will move." />
