...
export function MemberSetupShell({ children, wide = false }: { children: ReactNode; wide?: boolean }) {
  return <div className="member-setup-shell">
    ...
    <main className={`member-setup-main${wide ? ' member-setup-main-wide' : ''}`}>{children}</main>
